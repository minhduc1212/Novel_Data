...
if __name__ == '__main__':
    ...
    output_path = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "goodreads", "clean_novel_isbns.txt"))
    if not os.path.exists(os.path.dirname(output_path)):
        output_path = os.path.join(SCRIPT_DIR, "clean_novel_isbns.txt")
    extract_novels_from_massive_dump(data_path, output_path)